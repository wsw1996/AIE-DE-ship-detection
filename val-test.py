...
if __name__ == '__main__':
    # 加载模型
    model = YOLO(r'E:\迪菲尔赫曼\ultralytics-main\ultralytics\run-lowlight\train+yolov8l\exp+yolov8l\weights\best.pt')
    # 验证模型
    metrics = model.val(
        val=True,  # (bool) 在训练期间进行验证/测试
        data=r'E:\迪菲尔赫曼\ultralytics-main\ultralytics\cfg\datasets\Sealow_ship.yaml',
        ...
        project='run-lowlight/test-yolov8l-2800',  # 项目名称（可选）
        name='exp-yolov8l-2800',  # 实验名称，结果保存在'project/name'目录下（可选）
