...
#ultralytics-main/ultralytics/cfg/models/v5/CPA-yolov5.yaml
#ultralytics-main/ultralytics/cfg/models/v6/CPA-yolov6.yaml
#ultralytics-main-F/ultralytics/cfg/models/v8/AA-dehazeformer-yolov8.yaml

if __name__ == '__main__':
    model = YOLO('/root/ultralytics-main-F/ultralytics/cfg/models/v8/AA-Transweather-yolov8.yaml')
    # model = YOLO('/root/ultralytics-main/runs0612-Sea-add/train-impov8-m/exp-impov8-m/weights/last.pt')
    # model.load('yolov8n.pt') # loading pretrain weights
    model.train(data='/root/ultralytics-main-F/dataset/SeaHY-add-1.yaml',
                epochs=200,  # (int) 训练的周期数
                patience=500,  # (int) 等待无明显改善以进行早期停止的周期数
                ...
                project="runs-1028-SeaHY/train-Transweather-v8",  # (str, optional) 项目名称
                name="exp-Transweather-v8",  # (str, optional) 实验名称，结果保存在'project/name'目录下
